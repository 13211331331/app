...
$InitPHP_conf['service']['path'] = './web/library/Service/'; //service路径
...
$InitPHP_conf['db']['default'][0]['password']              	= 'hanlin'; //数据库密码
$InitPHP_conf['db']['default'][0]['database']              	= 'myweb'; //数据库
...
$InitPHP_conf['dao']['path']  = '/web/library/Dao/'; //后缀
